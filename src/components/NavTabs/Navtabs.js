        ...
        <div className="container-fluid" id="navTabs">
            <div className="row text-white bg-black py-1">
                ...
                <div className="col d-flex flex-row-reverse align-items-end">
                    <a href="https://drive.google.com/file/d/1ljraWxreLJGLUphwxcq5H6Z4vePdqj_1/view?usp=sharing" target="_blank" className="p-3 aboutMe text-decoration-none text-white">Resume</a>
